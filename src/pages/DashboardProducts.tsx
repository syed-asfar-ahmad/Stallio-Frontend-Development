...
export default function DashboardProducts() {
  ...
  return (
    <DashboardLayout>
      <div className="mb-5 max-lg:mb-5 lg:mb-8 min-w-0">
        ...
        <div className="mt-3 flex flex-col gap-2.5 min-w-0 lg:hidden">
          ...
          <PlanUsageBar
            ...
            label={t('dashboard.products.planLimitUsage', { count: products.length, max: planLimits.maxProducts })}
            limitReached={productLimitReached}
          />
          {products.length > 0 && (
            bulk.selectionMode ? (
      ...
      <PlanLimitBanner show={productLimitReached && canUpgradePlan(user?.plan)} />
