...
function FooterLink({
  ...
  return (
    <Link
      to={to}
      onClick={() => window.scrollTo(0, 0)}
      className="group inline-flex min-w-0 w-full items-center gap-2 rounded-lg py-1 text-sm font-medium text-stone-600 transition-colors hover:bg-brand-50/60 hover:text-brand-800 no-underline dark:text-zinc-300 dark:hover:bg-brand-950/40 dark:hover:text-brand-200"
    >
      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-stone-100 text-brand-600 ring-1 ring-stone-200/80 transition-colors group-hover:bg-brand-100/80 group-hover:text-brand-800 dark:bg-zinc-800 dark:text-brand-400 dark:ring-zinc-600 dark:group-hover:bg-brand-950/80 dark:group-hover:text-brand-200">
    ...
    >
      ...
      {!hideFooter && (
        <footer className="relative mt-auto border-t border-stone-200/90 bg-[#fafaf9] dark:border-zinc-700/90 dark:bg-zinc-950">
          ...
          <div className="relative mx-auto w-full max-w-7xl px-4 py-4 max-lg:px-4 sm:py-5 lg:px-5 lg:py-6 pb-[max(0px,env(safe-area-inset-bottom,0px))]">
            <div className="flex flex-col gap-3 rounded-2xl border border-stone-200/90 bg-white/70 p-3 shadow-sm shadow-stone-200/40 backdrop-blur-sm dark:border-zinc-700/80 dark:bg-zinc-900/50 sm:flex-row sm:items-center sm:justify-between sm:p-4">
              <div className="min-w-0">
                <Link
                  to="/"
                  onClick={() => window.scrollTo(0, 0)}
                ...
                <p className="mt-1 max-w-md text-xs leading-relaxed text-stone-600 dark:text-zinc-300 sm:text-sm">
                  {t('layout.footer.tagline')}
                </p>
              </div>
            ...
            <div className="mt-3 grid w-full grid-cols-1 gap-2.5 sm:grid-cols-2 lg:grid-cols-3">
              <div className="min-w-0 rounded-xl border border-stone-200/80 bg-white/60 p-3 dark:border-zinc-700/70 dark:bg-zinc-900/40">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-brand-700 dark:text-brand-400">
                  {t('layout.footer.linksHeading')}
                </p>
              ...
              <div className="min-w-0 rounded-xl border border-stone-200/80 bg-white/60 p-3 dark:border-zinc-700/70 dark:bg-zinc-900/40">
                ...
                <a
                  href="mailto:contact@stallio.shop"
                  className="mt-2 flex w-full min-w-0 items-center gap-3 rounded-xl border border-stone-200/80 bg-white p-2.5 shadow-sm transition-shadow hover:border-brand-200 hover:shadow-md no-underline dark:border-zinc-600 dark:bg-zinc-800 dark:hover:border-brand-600/40"
                >
                ...
                <p className="mt-3 text-xs font-bold uppercase tracking-[0.2em] text-brand-700 dark:text-brand-400">
                  {t('layout.footer.socialHeading')}
                </p>
                <div className="mt-2 flex flex-wrap gap-2">
                  {marketingSocialLinks.map((link, i) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-stone-200 bg-white text-stone-600 shadow-sm transition-all hover:border-brand-200 hover:bg-brand-50/50 dark:border-zinc-500 dark:bg-zinc-700 dark:text-zinc-100 dark:hover:border-brand-500/50 dark:hover:bg-zinc-600"
                      style={{ color: getSocialBrandColor(link.platform) }}
                      aria-label={link.platform}
                    >
              ...
              <div className="min-w-0 rounded-xl border border-stone-200/80 bg-white/60 p-3 dark:border-zinc-700/70 dark:bg-zinc-900/40 sm:col-span-2 lg:col-span-1">
                <p className="text-xs font-bold uppercase tracking-[0.2em] text-brand-700 dark:text-brand-400">
                  {t('layout.footer.legalHeading')}
                </p>
                <nav className="mt-2 flex flex-col gap-2.5" aria-label={t('layout.footer.legalNavAria')}>
                  {footerLegal.map(({ to, label, icon: LegIcon }) => (
                    <Link
                      key={to}
                      to={to}
                      onClick={() => window.scrollTo(0, 0)}
                      className="group flex items-center gap-2 rounded-lg py-0.5 text-sm font-medium text-stone-600 no-underline transition-colors hover:bg-brand-50/60 hover:text-brand-800 dark:text-zinc-300 dark:hover:bg-brand-950/40 dark:hover:text-brand-200"
                    >
                      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-stone-100 text-brand-600 ring-1 ring-stone-200/80 transition-colors group-hover:bg-brand-100/80 group-hover:text-brand-800 dark:bg-zinc-800 dark:text-brand-400 dark:ring-zinc-600 dark:group-hover:bg-brand-950/80 dark:group-hover:text-brand-200">
                        <LegIcon className="h-3.5 w-3.5" aria-hidden />
                      </span>
                      {label}
                    </Link>
                  ))}
            ...
            <div className="mt-3 border-t border-stone-200/90 py-1.5 dark:border-zinc-700">
